...
exports.RuleTable = exports.Dex = exports.ModdedDex = exports.toID = void 0;
...
Object.defineProperty(exports, "RuleTable", { enumerable: true, get: function () { return dex_formats_1.RuleTable; } });
...
const gen8 = __importStar(require("../data/mods/gen8"));
const gen9 = __importStar(require("../data"));
const formats9 = __importStar(require("../data/formats-data"));
const learn2 = __importStar(require("../data/mods/gen2/learnsets"));
const learn6 = __importStar(require("../data/mods/gen6/learnsets"));
const learn8 = __importStar(require("../data/mods/gen8/learnsets"));
const learn9 = __importStar(require("../data/learnsets"));
const pokemongo = __importStar(require("../data/pokemongo"));
const legality2 = __importStar(require("../data/mods/gen2/legality"));
const legality6 = __importStar(require("../data/mods/gen6/legality"));
const legality8 = __importStar(require("../data/mods/gen8/legality"));
const legality9 = __importStar(require("../data/legality"));
