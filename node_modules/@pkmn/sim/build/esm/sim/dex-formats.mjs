...
import { assignMissingFields, toID, BasicEffect } from './dex-data.mjs';
import { Tags } from '../data/tags.mjs';
import { Formats } from '../config/formats.mjs';
...
export class Format extends BasicEffect {
    constructor(data) {
        ...
        this.effectType = Utils.getString(data.effectType) || 'Condition';
...
export class DexFormats {
    ...
    validateBanRule(rule) {
        ...
        const ruleid = id;
        if (this.dex.data.Aliases.hasOwnProperty(id))
            id = toID(this.dex.data.Aliases[id]);
        for (const matchType of matchTypes) {
...
//# sourceMappingURL=dex-formats.mjs.map