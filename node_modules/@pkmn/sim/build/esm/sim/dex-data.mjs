 ...
 */
export function assignMissingFields(self, data) {
    for (const k in data) {
        if (k in self)
            continue;
        self[k] = data[k];
...
export class Nature extends BasicEffect {
    constructor(data) {
        super(data);
...
export class TypeInfo {
    constructor(data) {
        this.name = data.name;
        this.id = data.id;
        this.effectType = Utils.getString(data.effectType) || 'Type';
        this.exists = data.exists ?? !!this.id;
        this.gen = data.gen || 0;
        this.isNonstandard = data.isNonstandard || null;
...
//# sourceMappingURL=dex-data.mjs.map