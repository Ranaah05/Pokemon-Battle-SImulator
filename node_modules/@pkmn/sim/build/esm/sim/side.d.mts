import { ActiveMove, AnyObject, Battle, Condition, Effect, ID, Move, MoveTarget, PokemonSet, SideID, StatsExceptHPTable } from './exported-global-types';
...
export declare class Side {
    ...
    emitRequest(update: ChoiceRequest): void;
